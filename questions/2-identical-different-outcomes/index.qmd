...
## שאלה
 ...
 עבור כל יוזר החזר את מספר התשלומים שהוא קיבל, האם כל התשלומים שהוא קיבל הם עם סטטוס 'Load' (1 כן, 0 לא), האם מספר התשלומים שנטענו היה גדול ממספר התשלומים שבוטלו (1 כן, 0 לא) והאם יש לו לפחות תשלום אחד שהוא 'Pending' (1 כן, 0 לא)
