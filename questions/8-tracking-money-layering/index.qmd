...
כלומר, בהינתן שהתשלום הראשון התרחש ממשתמש 7804, מי היה היוזר האחרון שקיבל את הסכום משרשרת ההעברות? במילים אחרות, משתמש 7804 שלח את הכסף למשתמש אחר שהעביר למשתמש אחר וכן הלאה, מי המשתמש האחרון שקיבל את הכסף הזה ולא העביר אותו הלאה?

<details>
<summary>רמז</summary>
יכולות להיות פה כמה קפיצות ארוכות, נסו לחשוב על דרך לפתור את זה בלי לבצע `JOINS` חוזרים ונשנים.
